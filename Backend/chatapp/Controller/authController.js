...
const { generateOTP, sendOTPEmail, cleanupFailedRegistration, } = require("../Utilities/verificationUtility");
...
export const register = async (req, res) => {
    ...
    try {
        ...
        // Generate JWT Token
        const token = jwt.sign({ id: user._id, email: user.email }, process.env.JWT_SECRET, // Ensure JWT_SECRET is set in your environment variables
