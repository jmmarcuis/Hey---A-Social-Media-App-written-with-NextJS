...
export default function PersonalInfoPage() {
    ...
    return (
        ...
        focus:ring-2 focus:ring-black focus:outline-none focus:border-transparent dark:bg-black
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-4 py-3 rounded-lg border  border-gray-300 dark:border-gray-600 
                                focus:ring-2 focus:ring-black focus:border-transparent dark:bg-black bg-white
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 rounded-lg border ${errors.dateOfBirth ? 'border-red-500' : 'border-gray-300'} dark:border-gray-600 
                                focus:ring-2 focus:ring-black focus:border-transparent  focus:outline-none dark:bg-black
